...
i was curious when i came across this paper. after all, it's something like NAND for mathematics. out of curiosity i researched more about it and ended up few-shotting a basic webapp describing a few ideas explored by an LLM, plus a playground.
